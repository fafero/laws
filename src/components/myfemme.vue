<template>
  <div class="myfem">
    ...
    <div class="div2">
            ...
            <select name="tai" id="tai" required>
            ...
            <!-- <select name="mot" id="mot" required>
            <option value="">--Choisissez votre motif--</option>
            <option value="motif1"><img src="../assets/motif1.jpg" alt="imgmotif" class="imgmotif"/></option>
            <option value="motif2"><img src="../assets/motif2.jpg" alt="imgmotif" class="imgmotif"/></option>
            <option value="motif3"><img src="../assets/motif3" alt="imgmotif" class="imgmotif"/></option>
            <option value="motif4"><img src="../assets/motif4.jpg" alt="imgmotif" class="imgmotif"/></option>
            <option value="motif5"><img src="../assets/motif5.jpg" alt="imgmotif" class="imgmotif"/></option>
            </select> -->
...
<script>
    ...
    this.recupLocalStorage();
        ...
        methods: {
          getAll (){
            let url="http://164.132.224.172:5000/produit/findbydescription/femme";
            this.axios.get(url)
            .then((response) =>{
