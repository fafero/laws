    ...
    <div class='container'>
        <div class='columns'>
            <div class='column is-4'>
                <img src="image.jpeg" alt="contenupanier.libelle">
            </div>
            <div class='column is-4'>            
                <div class='field'>
                    <label>Name</label>
            ...
            <div class='column is-4'>         
                ...
                <div class="field">
                    <label>Address</label>
                    <input type='text' class='input' v-model='address' placeholder='123 Fake St #303'>
                </div>
                <!-- <div class="field">
                    <label>City</label>
...
export default {
    data(){
        return {
            stripeKey: 'pk_test_j9ocn5m1gRYDANQEIGzumbc500y2OgnpjC',
                ...
                axios.post(`${window.endpoint}/charge`, request)
                    .then((res) => {
                        ...
                        if (error){
                            ...
                            this.$router.push({ path: `/grandcomplete/${charge.id}` })
                        }
                    });
            }
        }
